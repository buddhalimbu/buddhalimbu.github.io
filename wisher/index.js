...
var quotes = [ "No matter how far is the\n distance between us  we are\n always together.","Good friends are like stars.\n You don't always see them,\n but you know they're\n always there.","There are friends, there \n is family and then there are\n friends that become family.","Many people will walk in \n and out of your life, but only true \n friends will leave footprints\n in your heart.","A friend is one who overlooks\n your broken fence and admires the\n flowers in your garden.","Be slow to fall into\n friendship; but when thou art in, continue\n firm & constant.","A friend is someone who understands\n your past, believes in your future,\n and accepts you just\n the way you are.","A true friend never gets\n in your\n way unless you happen\n to be going down.","True friends are never apart,\n maybe in distance but never in heart."];

var getQuote = quotes[Math.floor(Math.random() * quotes.length)];

//colors

var colors = [ "#d50000","#ff352b","#2babff","#47ff40","#ed6b5b","#3a3e59","#f9ac66","#c36b84","#4fa3a5","#63c5ea","#ea4b8b","#4eb1b3"];
...
var color = colors[Math.floor(Math.random()*colors.length)];
        ...
        if(fname==="" || xname===""){
            ...
            setTimeout(function() {
             loader.classList.remove('active');},3000);
            }
...
$('.wish-again span').onclick = () => {
    ...
    setTimeout(function(){
            $('.myloader').classList.remove('active');},3000);
...
const x = document.createElement('textarea'); x.value = str; 
...
setTimeout(function(){
    $('.info').classList.remove('active');},2000);
